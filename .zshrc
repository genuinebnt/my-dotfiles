...
# my aliases
alias ls='exa --icons'
alias dwmconf='lvim ~/.config/dwm/config.h'
alias kittyconf='lvim ~/.config/kitty/kitty.conf'
alias szshrc='source ~/.zshrc'
alias zshconf='lvim ~/.zshrc'
alias rcconf='lvim ~/.config/ranger/rc.conf'
...
alias parufind="paru -Sl | awk '{print \$2(\$4==\"\" ? \"\" : \" *\")}' | sk --multi --preview 'paru -Si {1}' | cut -d \" \" -f 1 | xargs -ro paru -S"
alias open="xdg-open"
...
alias fzf='fzf --ansi'
alias fdh='fd --type d --hidden --exclude .git --exclude node_modules'
alias rgp='rg --column --line-number --no-heading --color=always'
alias ffp='find . -type f -iname'
alias fdn='fd --type d --hidden --exclude .git --exclude node_modules | fzf'
